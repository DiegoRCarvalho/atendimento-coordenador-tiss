...
@section('brand')Ver Atendimento @endsection

@section('title')Ver Atendimento @endsection

@section('content')
    <div class="container mt-2" >

            <div class="form-row">
                <div class="alert alert-success col-12" role="alert" style="text-align:center;" name="message">Atendimento finalizado!</div>
            </div>
        <form name="attendance"  method="POST">
            ...
            <div class="form-row">
                ...
                <fieldset disabled class="col-2">
                    <div class="form-group" >
                        ...
                        <input type="text" class="form-control form-control-sm protocol" id="protocol" name="protocol"
            ...
            <div class="form-row col-12 p-0">
                <div class="col-10 p-0">
                        ...
                        <div class="form-row">
                            <div class="form-group col-5">
                                <label for="errorDetails">* Detalhe do erro</label>
                                  <select id="errorDetails" class="form-control form-control-sm" name="errorDetails" required disabled>
                                        <option selected>{{($query['error_detail'] == null) ? 'Escolher...' : $query['error_detail']}}</option>
                            ...
                            <div class="form-group col-5">
                                <label for="solutionDetails">Solução</label>
                                    <select id="solutionDetails" class="form-control form-control-sm border border-success" name="solutionDetails" disabled>
                                        <option selected>{{($query['solution_detail'] == null) ? 'Escolher...' : $query['solution_detail']}}</option>
                            ...
                            <div class="form-group col-2">
                                <label for="forwardTo">Encaminhar para</label>
                                    <select id="forwardTo" class="form-control form-control-sm" name="forwardTo" disabled>
                                        <option selected>{{($query['forward_to'] == null) ? 'Escolher...' : $query['forward_to']}}</option>
                        ...
                        <div class="form-row">
                            <div class="form-group col-12">
                                <label for="note" disabled>Observação</label>
                ...
                <div class="col-2 rightSidebar pl-3">
                    ...
                    <a class="btn btn-secondary btn-block" href="{{route('authenticated.home')}}">Voltar</a>
                </div>
            </div>
        </form>
    </div>
